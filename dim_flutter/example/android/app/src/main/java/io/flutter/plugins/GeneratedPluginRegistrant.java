...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.duda.dim_flutter.DimFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin dim_flutter, com.duda.dim_flutter.DimFlutterPlugin", e);
    }
    try {
